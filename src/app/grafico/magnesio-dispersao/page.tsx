...
export default function MagnesioDispersao() {
  return (
    <div className='font-sans flex flex-col items-center justify-center min-h-screen p-8 bg-gray-50 text-gray-900'>
      ...
      <nav className='flex justify-center gap-6 text-sm mb-4'>
        ...
        <a href='/grafico/magnesio-dispersao' className='text-blue-600'>
          Dispersão Magnésio
        </a>
      </nav>
      ...
      <p className='mb-4 text-sm text-gray-600'>
        Pontos vermelhos representam outliers do Magnésio pelo critério IQR.
      </p>
      <div className='w-full max-w-5xl'>
        <ScatterOutlierChart variavel='Mg' color='#8B5CF6' />
      </div>
    </div>
  );
}
