...
export default function ProdutividadeDispersao() {
  return (
    <div className='font-sans flex flex-col items-center justify-center min-h-screen p-8 bg-gray-50 text-gray-900'>
      ...
      <p className='mb-4 text-sm text-gray-600'>
        Pontos vermelhos representam outliers de Produtividade pelo critério
        IQR.
      </p>
      <div className='w-full max-w-5xl'>
        <ScatterOutlierChart variavel='PROD' color='#2563EB' />
      </div>
    </div>
  );
}
