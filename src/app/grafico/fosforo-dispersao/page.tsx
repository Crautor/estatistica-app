...
export default function FosforoDispersao() {
  return (
    <div className='font-sans flex flex-col items-center justify-center min-h-screen p-8 bg-gray-50 text-gray-900'>
      ...
      <nav className='flex justify-center gap-6 text-sm mb-4'>
        <a href='/grafico/produtividade-dispersao' className='text-gray-900 hover:text-blue-600'>
      ...
      <p className='mb-4 text-sm text-gray-600'>
        Pontos vermelhos representam outliers de Fósforo pelo critério IQR.
      </p>
      <div className='w-full max-w-5xl'>
        <ScatterOutlierChart variavel='P' color='#10B981' />
      </div>
    </div>
  );
}
